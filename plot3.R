## Plot 3: Energy Sub-Metering Time Series Plot
...
# plot and close out
# note seg.len = 2 is 'about' the same length of the lines
# in the legend we are comparing to
plot.new()
png(filename='plot3.png',height=480,width=480, units='px',bg='white')
par(mfrow=c(1,1),mar=c(5,5,2,2))
with(DF, plot(datetime, sub1,type="n",ylab='Energy sub metering',xlab=''))
with(DF, lines(datetime,sub1,col='black'))
with(DF, lines(datetime,sub2,col='red'))
with(DF, lines(datetime,sub3,col='blue'))
legend("topright", lty=1,seg.len=2, col = c('black','red','blue'), 
